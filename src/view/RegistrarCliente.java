...
<<<<<<< HEAD
    ...
    ());
    cliente.setCodDocumento (Integer.parseInt
    ...
    (telefono));
    cliente.setSexo (Sexo.getSelectedItem
    ().toString());
    ...
    ());
    mascota.setEdadMascota (Integer.parseInt

    (Edad.getText()));
    mascota.setPesoMascota (Integer.parseInt

    (Peso.getText()));
    mascota.setSexoMascota (SexoMascota.getSelectedItem
    ...
    especie.setTipoEspecie (JComboBoxTE.getSelectedItem
    ().toString());
            
        Raza raza = new Raza();

    raza.setTipoRaza (JComboBoxTR.getSelectedItem
    ().toString());
...
"Cliente y mascota guardados exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
